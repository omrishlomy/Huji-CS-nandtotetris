    ...
    while True:
        if parser.command_type() == "C_ARITHMETIC":
            ...
            code_writer.write_push_pop(parser.command_type(), parser.arg1(),
                                       parser.arg2())
        elif parser.command_type() in {"C_LABEL", "C_GOTO", "C_IF-GOTO"}:
            code_writer.write_branching(parser.command_type(), parser.arg1())
        elif parser.command_type() in {"C_FUNCTION", "C_CALL"}:
            code_writer.function_commands(parser.command_type(), parser.arg1(), int(parser.arg2()))
